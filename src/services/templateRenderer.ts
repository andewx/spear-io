...
export interface IRenderOptions {
  layout?: string | false; // Layout file (default: 'main'), false for no layout
  page?: string; // Active page identifier for nav highlighting
  title?: string; // Page title
  [key: string]: unknown; // Additional template data
}
 ...
 */
export async function sendViewOrJSON(
  res: Response,
  data: Record<string, unknown>,
  viewName: string,
  options: IRenderOptions = {}
