...
export class SyntheticController {
     ...
     */
    async generatePrecipitationField(req, res) {
        try {
     ...
     */
    async generateFieldImage(scenario) {
     ...
     */
    async generateHighPassOverlay(rainRateField, width, height, scenarioId) {
     ...
     */
    async servePrecipitationImage(req, res) {
        try {
...
//# sourceMappingURL=SyntheticController.js.map